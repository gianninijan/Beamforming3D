...
for jj = 1:numUE,
    ...
    for s = 1:S,
        ...
        if s ~= setor,
            ...
            % angulo de STEERING da BS do setor_s no SLOT DE TEMPO 'inst'
...
mtAngsThetaTild_gr = repmat(angDownTild_gr, FatorSetor*M, 1); % [linha, coluna] = [setor, grupos do ang. Inclinação] 
